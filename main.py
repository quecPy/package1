...
class LCD_ST7735(Peripheral_LCD):
    def __init__(self, InitData=None, width=m_width, height=m_height, clk=26000, dir=m_screen_stypletyple):
        self.gpio = None
        self.lcd = None
        self._lcd_w = None
        self._lcd_h = None
    ...
    def _LcdInit(self, InitData, width, height, dir, clk):
        self.gpio = Pin(mdls.model_gpio[gpio_type]["lcd"][0], Pin.OUT, Pin.PULL_DISABLE, 1)
        L2R_U2D = 0
        L2R_D2U = 1
        R2L_U2D = 2
        R2L_D2U = 3
        ...
        regval = 0
        if (dir == L2R_U2D):
            regval |= (0 << 7) | (0 << 6) | (0 << 5) | (0 << 4)| (0 << 3) #0x00 竖屏 128*160  0
        elif dir == L2R_D2U:
            regval |= (0 << 7) | (0 << 6) | (0 << 5) | (0 << 4)| (1 << 3) #0x08 竖屏  128*128 1
        elif dir == R2L_U2D:
            regval |= (1 << 7) | (0 << 6) | (1 << 5) | (0 << 4)| (0 << 3) #0xA0 横屏 128*160  2
        elif dir == R2L_D2U:
            regval |= (1 << 7) | (0 << 6) | (1 << 5) | (0 << 4)| (1 << 3) #0xA8 横屏 128*128  3
        elif dir == U2D_L2R:
            regval |= (0 << 7) | (1 << 6) | (1 << 5) | (0 << 4)| (1 << 3) #0x68  横屏 翻转 128*128  4
        elif dir == U2D_R2L:
            regval |= (0 << 7) | (1 << 6) | (1 << 5) | (0 << 4)| (0 << 3) # 0x60 横屏 翻转 128*160 5
        elif dir == D2U_L2R:
            regval |= (1 << 7) | (1 << 6) | (0 << 5) | (0 << 4)| (0 << 3) # 0xC0 竖屏翻转 128*160 6
        elif dir == D2U_R2L:
            regval |= (1 << 7) | (1 << 6) | (0 << 5) | (0 << 4)| (1 << 3) # 0xC8 竖屏翻转 128*128 7
